...
{
    private double l8 = Normal.Inverse(0.8);
    private double l9 = Normal.Inverse(0.9);
    private double l95 = Normal.Inverse(0.95);
    ...
    public IDictionary<DateTime, Series<string, double>> Run(
        IEnumerable<(int shortWindow, int longWindow, double weight)> filters, int nWindow)
    {
        var fs = 1.0;
        var order = 11;
